...
首页、关于页、在校经历与个人轨迹使用第一人称或自然的简短叙述，直接介绍正在做的项目、实习和笔记。用具体事情说明技术方向，少用“持续构建能力”等抽象表达；入口用自然、明确的短句，不把个人介绍写成编号档案。列表页介绍面向访客，不写“复用项目集合”等实现说明。不要为增加亲近感编造爱好、情绪或经历；项目已完成的功能与接下来想做的部分仍须区分。
